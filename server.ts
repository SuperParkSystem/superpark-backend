...
const options = {
  ...
  apis: [
    "./routes/driver_routes.ts",
    "./routes/auth_routes.ts",
    "./routes/parkingOwner_routes.ts",
    "./routes/productOwner_routes.ts",
  ],
};
...
import productOwner_router from "./routes/productOwner_routes";
...
app.use("/productOwner", productOwnerAuth);
app.use("/productOwner", productOwner_router);
